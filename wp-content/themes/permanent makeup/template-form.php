    ...
    ?>
        ...
        <div class="survey-grid">
            ...
            <div class="field">
                ...
                <input type="number" id="age" name="age" placeholder="<?php echo esc_attr( pll__('Tilføj') ); ?>"
            ...
            <div class="field">
                ...
                <input type="text" id="city" name="city" placeholder="<?php echo esc_attr( pll__('Tilføj') ); ?>"
                    required>
            </div>
        </div>
        ...
        <fieldset class="likert">
            ...
            <div class="likert-row">
                ...
                <div class="likert-col">
                    <input type="radio" id="<?php echo esc_attr("q{$idx}_{$s}"); ?>"
                        name="<?php echo esc_attr("q{$idx}"); ?>" value="<?php echo esc_attr($label); ?>" required>
