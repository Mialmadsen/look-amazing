<footer class="site-footer">
  ...
  if ( !empty($location_img) ) : ?>
            <img src="<?php echo esc_url($location_img['url']); ?>" alt="<?php echo esc_attr($location_img['alt']); ?>"
    ...
    <div class="footer-socials">
        <a href="<?php the_field('facebook_url', "option"); ?>" target="_blank"
            aria-label="Dette er et simpelt hvidt Facebook Icon, som linker til Facebook">
            <i class="fab fa-facebook-f"></i>
        </a>

        <a href="<?php the_field('instagram_url', "option"); ?>" target="_blank"
            aria-label="Dette er et simpelt hvidt Instagram Icon, som linker til Instagram">
