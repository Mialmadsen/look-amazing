...
export const ProductIcon = ( { slug } ) => {
	...
	switch ( slug ) {
		...
		case 'careers':
			return (
				...
				>
					...
					>
						<G
							clipPath={ sprintf( 'url(#%s-a)', svgPrefix ) }
						>
							<Rect
								fill="#fff"
								height="256"
			...
			return (
				...
				>
					...
					>
						...
						<G
							mask={ sprintf( 'url(#%s-a)', svgPrefix ) }
						>
							<Path
								fill="#111"
		...
		// Password Requirements plugin icon.
			...
			return (
				...
				>
					...
					>
						<Path
							fill="#F0F2FF"
							d="M113 113h274v274H113z"
						/>
						<G
							clipPath={ sprintf( 'url(#%s-a)', svgPrefix ) }
							filter={ sprintf( 'url(#%s-b)', svgPrefix ) }
						>
							<Path
								fill="#0E38F4"
						...
						<defs>
							...
							>
								...
								<feBlend
									in2="shape"
									result="effect1_innerShadow_171_139"
								/>
							</filter>
						</defs>
					</SVG>
				...
				>
					...
					>
						...
						>
							...
							/>
							<G
								clipPath={ sprintf( 'url(#%s-b)', svgPrefix ) }
								mask={ sprintf( 'url(#%s-c)', svgPrefix ) }
							>
								<Path
		...
		>
			...
			>
				...
				>
					...
					<G
						mask={ sprintf( 'url(#%s-b)', svgPrefix ) }
					>
						<Rect
							fill="#FCEBD8"
							height="256"
						...
						/>
						<G
							clipPath={ sprintf( 'url(#%s-c)', svgPrefix ) }
						>
							<Path
				...
				<defs>
					...
					>
						<Path
							fill="#fff"
							transform="translate(-29.31 40.96)"
							d="M0 0h256v256H0z"
						/>
					</clipPath>
				</defs>
